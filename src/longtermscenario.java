...
public class longtermscenario {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		//driver.findElement(By.xpath("(//input[@type='number'])[1]")).sendKeys("10");//market order
		//Thread.sleep(2000);
		
		//driver.findElement(By.xpath("(//div[@class='su-radio-wrap'])[1]")).click();    //market order
		driver.findElement(By.xpath("//input[@id='radio-162']")).click();    //limit order
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@type='number'])[1]")).sendKeys("10");
		
		//driver.findElement(By.xpath("(//input[@type='number'])[1]")).sendKeys("10");   //limit order
		Thread.sleep(2000);
		//driver.findElement(By.xpath("(//input[@type='number'])[2]")).sendKeys("609");
